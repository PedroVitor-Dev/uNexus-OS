...
`unexus-shell` owns the desktop wallpaper, top bar, side docks, launcher, Settings, Game Settings, uNexus Files, uNexus CMD, uNexus AI, notifications, login flow, stats overlay and Hyprland-facing window controls.
