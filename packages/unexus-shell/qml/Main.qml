...
Window {
    ...
    property var ptBr: ({
        ...
        "Notifications enabled": "Notifica��es ativas",
        "Notifications disabled": "Notifica��es desativadas",
        "Launcher shortcut": "Atalho do launcher",
        "Settings shortcut": "Atalho das configura��es",
        "Game Settings shortcut": "Atalho dos jogos",
        "Stats shortcut": "Atalho das estat�sticas",
        "Reset": "Redefinir",
        "Launcher": "Launcher",
