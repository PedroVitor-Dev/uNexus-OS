...
Window {
    ...
    property var ptBr: ({
        ...
        "AI model": "Modelo IA",
        "No local model found": "Nenhum modelo local encontrado",
        "Refresh models": "Atualizar modelos",
        "Change model": "Trocar modelo",
        "Start AI": "Iniciar IA",
        "Stop AI": "Parar IA",
        "Install a GGUF model with setup-ai-model.sh, then start the local engine here.": "Instale um modelo GGUF com setup-ai-model.sh e inicie o engine local aqui.",
        ...
        "Notifications silenced": "Notificacoes silenciadas",
